...
import (
	...
	"github.com/kubespace/kubespace/pkg/server/views/project_views"
	"github.com/kubespace/kubespace/pkg/server/views/settings_views"
	"github.com/kubespace/kubespace/pkg/service/pipeline"
	project2 "github.com/kubespace/kubespace/pkg/service/project"
)

type ViewSets map[string][]*views.View

func NewViewSets(serverConfig *config.ServerConfig, kr *kube_resource.KubeResources, models *model.Models) *ViewSets {
