...
func NewUserRole(models *model.Models) *UserRole {
	...
	views := []*View{
		...
		NewView(http.MethodPost, "", role.update),
		NewView(http.MethodDelete, "/:id", role.delete),
	}
	role.Views = views
...
func (r *UserRole) list(c *Context) *utils.Response {
...
func (r *UserRole) update(c *Context) *utils.Response {
...
func (r *UserRole) delete(c *Context) *utils.Response {
