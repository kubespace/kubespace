          ...
          <el-table-column label="操作" width="150">
            <template slot-scope="scope">
              <div class="tableOperate">
                <el-link :underline="false" type="primary" style="margin-right: 13px; color:#409EFF" :href="'/api/v1/apps/download?scope=appstore&path='+scope.row.chart_path">下载</el-link>
