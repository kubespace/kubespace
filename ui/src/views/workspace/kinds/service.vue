<template>
  <div class="template-class">
    <el-form label-position="left" :model="template.metadata" :rules="rules" style="padding: 10px 20px 10px" label-width="100px">
      ...
      <el-form-item label="" prop="port" >
        <el-row style="margin-bottom: 5px; ">
          ...
          <el-col v-if="template.spec.type == 'NodePort'" :span="4" style="background-color: #F5F7FA">
            <div class="border-span-header">
              <span  class="border-span-content">*</span>NodePort
            </div>
          </el-col>
          <el-col :span="4" style="background-color: #F5F7FA">
            <div class="border-span-header">
        ...
        <el-row style="padding-top: 0px;" v-for="(item, idx) in template.spec.ports" :key="idx">
          ...
          <el-col :span="4">
            <div class="border-span-header">
              <el-input v-model="item.port" size="small" style="padding-right: 10px" placeholder="服务暴露端口，如：80"></el-input>
            </div>
          </el-col>
          <el-col v-if="template.spec.type == 'NodePort'" :span="4">
            <div class="border-span-header">
              <el-input v-model="item.nodePort" size="small" style="padding-right: 10px" placeholder="服务暴露端口，如：80"></el-input>
            </div>
          </el-col>
          <el-col :span="4">
            <div class="border-span-header">
              <!-- <el-input v-model="item.containerPort" size="small" style="padding-right: 10px" placeholder="容器访问端口，如：80"></el-input> -->
              <el-select v-model="item.protocal" placeholder="端口所属协议" size="small" style="padding-right: 10px">
                <el-option label="TCP" value="TCP"></el-option>
                <el-option label="UDP" value="UDP"></el-option>
                <el-option label="SCTP" value="SCTP"></el-option>
                <!-- <el-option v-for="p in containers." -->
              </el-select>
            </div>
          </el-col>
          <el-col :span="4">
            <div class="border-span-header">
              <el-select v-model="item.protocal" placeholder="端口所属协议" size="small">
                <el-option label="TCP" value="TCP"></el-option>
                <el-option label="UDP" value="UDP"></el-option>
                <el-option label="SCTP" value="SCTP"></el-option>
              </el-select>
        ...
        <el-row>
          ...
          <el-button style="width: 100%; border-radius: 0px; padding: 9px 15px; border-color: rgb(102, 177, 255); color: rgb(102, 177, 255)" plain size="mini" 
            @click="template.spec.ports.push({protocal: 'TCP'})" icon="el-icon-plus">添加服务端口</el-button>
          </el-col>
        </el-row>
      </el-form-item>
    </el-form>
