...
var (
	...
	redisAddress    = flag.String("redis-address", utils.LookupEnvOrString("REDIS_ADDRESS", "192.168.47.150:6379"), "redis address used.")
	redisDB         = flag.Int("redis-db", utils.LookupEnvOrInt("REDIS_DB", 0), "redis db used.")
	redisPassword   = flag.String("redis-password", utils.LookupEnvOrString("REDIS_PASSWORD", ""), "redis password used.")
	...
	mysqlHost       = flag.String("mysql-host", utils.LookupEnvOrString("MYSQL_HOST", "192.168.47.150:3306"), "mysql address used.")
	mysqlUser       = flag.String("mysql-user", utils.LookupEnvOrString("MYSQL_USER", "root"), "mysql db user.")
	mysqlPassword   = flag.String("mysql-password", utils.LookupEnvOrString("MYSQL_PASSWORD", "root"), "mysql password used.")
